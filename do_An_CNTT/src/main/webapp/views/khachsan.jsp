        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div style="font-size: 14px; color: #007AD9; margin: 4px 0 10px 12px">
                    <img style="height: 22px" src="/do_An_CNTT/Content/Images/Position.png" alt="Img"/>
                    ${ks.diaChi}
                </div>
                <div style="margin-top: 20px; background-color: #E9F0FA; border-radius: 3px">
                    <div style="width: 800px; border-bottom: 1px solid #E0E0E0; padding-bottom: 20px; margin-bottom: 20px">
                        <div style="border-radius: 3px; width: 540px; overflow: hidden; margin: auto">
                            <img style="height: 440px" src="/do_An_CNTT/Content/Images/KhachSan/${ks.id}.jpg" alt="Img"/>
                        </div>
                    </div>
                </div>
                <div>
                        ...
                        <form action="${pageContext.request.contextPath}/timPhongTrong" method="post">
                            <div class="row" style="margin-top: 10px">
                                <div class="col-md-3">
                                    ...
                                    <div><input type="date" name="ngayDen" required></div>
                                </div>
                                <div class="col-md-3">
                                    <div>Ngày trả phòng</div>
                                    <div><input type="date" name="ngayTra" required></div>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div>
                        <form id="form-dsphong">
                            <table class="table-dsphong">
                                <tr>
                                    <th style="width: 15%">Phù hợp cho</th>
                                    <th style="width: 70%">Loại phòng</th> 
                                    <th style="width: 15%"></th>
                                </tr>
                                <c:forEach var="phong" items="${listPhong}">
                                    <tr>
                                        <td style="text-align: center">
                                            <img style="height: 30px" src="/do_An_CNTT/Content/Images/Giuong_${phong.loaiGiuong}.png" alt="Img"/>
                                        </td>
                                        <td>
                                            <div style="color: #0077CC; font-weight: bold">${phong.ten}</div>
                                            <div>${phong.dienTich} m2</div>
