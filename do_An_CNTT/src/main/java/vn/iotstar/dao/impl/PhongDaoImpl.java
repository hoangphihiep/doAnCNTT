...
public class PhongDaoImpl extends DBConnectionSQL implements IPhongDao {
	...
	public List<PhongModel> findAll() {
		String sql = "select P.Id, P.Ten, P.DienTich, P.GiaThue, P.TienNghi, P.MoTa, P.LoaiGiuong, P.IdKhachSan, K.Ten as TenKhachSan from Phong P, KhachSan K where P.IdKhachSan=K.Id";
	...
	public List<PhongModel> findByIdKhachSan(int idKhachSan) {
		String sql = "select P.Id, P.Ten, P.DienTich, P.GiaThue, P.TienNghi, P.MoTa, P.LoaiGiuong, P.IdKhachSan, K.Ten as TenKhachSan from Phong P, KhachSan K where K.Id = ? and P.IdKhachSan=K.Id";
		List<PhongModel> list = new ArrayList<PhongModel>();
		try {
			conn = new DBConnectionSQL().getConnection();
			ps = conn.prepareStatement(sql);
